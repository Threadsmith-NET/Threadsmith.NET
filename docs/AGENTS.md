...
- `architecture/adr-56-repository-only-approval-policy-preferences.md` owns repository-only approval-policy preferences and session override semantics, superseding the former plan-policy cross-store trust requirement.
