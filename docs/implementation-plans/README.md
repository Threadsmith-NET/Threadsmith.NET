...
| 95 | `plan-95-subagent-efficiency-code-explore-role-model-routing.md` | Subagent efficiency and residual code explore precision |
| 95.1 | `plan-95.1-subagent-role-runners-and-role-model-assignment.md` | Runnable subagent roles and role-based model assignment |
