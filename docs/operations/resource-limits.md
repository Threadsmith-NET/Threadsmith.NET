...
Ordinary configuration. [Implementation](../../src/Threadsmith.Skills/SkillCatalog.cs).
...
Ordinary configuration. [Implementation](../../src/Threadsmith.Skills/BoundedJsonSchema.cs).
...
Ordinary configuration. [Implementation](../../src/Threadsmith.Skills/SkillPackageSecurity.cs).
