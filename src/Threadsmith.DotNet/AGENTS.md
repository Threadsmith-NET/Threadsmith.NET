...
- `NaturalLanguageNameSegmentMatcher.cs` — CodeGraph-style declaration-name segmentation, prose-concept co-occurrence, rarity, and primary-subject confidence for natural-language exploration ranking.
