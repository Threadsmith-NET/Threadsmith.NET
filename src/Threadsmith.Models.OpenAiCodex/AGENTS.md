...
- Discovered reasoning names and defaults are retained as model-defined values, including `xhigh` and `max`; discovery and request projection must not collapse them to `high`.
