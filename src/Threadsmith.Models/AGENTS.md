...
- Structured schema-2 plans validate file-intent kinds, non-null bounded repository-relative paths, and move/rename destinations before they cross into execution state.
