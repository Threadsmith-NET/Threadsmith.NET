...
- Gather only enough to identify the target refs, changed-file list, applicable instructions, and supplied requirements. Once these are known, gathering is complete: proceed immediately to delegation. Pass remaining questions and evidence gaps to the specialists. Do not read every diff or supporting file, run builds/tests, or troubleshoot the environment before delegating.
