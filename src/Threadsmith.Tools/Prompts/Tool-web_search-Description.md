...
- query: required non-empty plain-text string, within the declared query maxLength and at most 75 whitespace-delimited words; no control characters or sensitive data.
...
- freshnessDays: optional integer from 1 through 365 limiting result age in days. Omit it for no freshness filter; do not send strings such as "7d".
