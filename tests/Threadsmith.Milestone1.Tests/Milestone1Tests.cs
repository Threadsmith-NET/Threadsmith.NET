...
public static class Milestone1Tests
{
    ...
    public static IEnumerable<object[]> LegalTransitionPaths =>
    [
        [new[] { RunPhase.RepositoryDiscovery }],
        [new[] { RunPhase.EvidenceCollection }],
        [new[] { RunPhase.RepositoryDiscovery, RunPhase.EvidenceCollection }],
        [new[] { RunPhase.EvidenceCollection, RunPhase.ChangePlanning }],
        [new[] { RunPhase.EvidenceCollection, RunPhase.ChangePlanning, RunPhase.Completion }],
        [new[] { RunPhase.EvidenceCollection, RunPhase.Completion }],
        [new[] { RunPhase.EvidenceCollection, RunPhase.ChangePlanning, RunPhase.AwaitingPlanApproval }],
        [new[] { RunPhase.EvidenceCollection, RunPhase.ChangePlanning, RunPhase.AwaitingPlanApproval, RunPhase.Completion }],
        [new[] { RunPhase.EvidenceCollection, RunPhase.ChangePlanning, RunPhase.AwaitingPlanApproval, RunPhase.ImplementationPreparing, RunPhase.Completion }],
        [new[] { RunPhase.EvidenceCollection, RunPhase.ChangePlanning, RunPhase.AwaitingPlanApproval, RunPhase.ImplementationPreparing, RunPhase.ImplementationModelTurn, RunPhase.MutationProposed, RunPhase.MutationStaged, RunPhase.AwaitingMutationApproval, RunPhase.BaselineValidation, RunPhase.MutationApplyPending, RunPhase.Mutation, RunPhase.Compilation, RunPhase.Testing, RunPhase.Verification, RunPhase.CompletionPending, RunPhase.Completion }],
        ...
        [new[] { RunPhase.EvidenceCollection, RunPhase.ChangePlanning, RunPhase.AwaitingPlanApproval, RunPhase.ImplementationPreparing, RunPhase.ImplementationModelTurn, RunPhase.MutationProposed, RunPhase.MutationStaged, RunPhase.AwaitingMutationApproval, RunPhase.BaselineValidation, RunPhase.MutationApplyPending, RunPhase.Mutation, RunPhase.Compilation, RunPhase.Testing, RunPhase.Verification, RunPhase.AwaitingAcceptance }],
        [new[] { RunPhase.EvidenceCollection, RunPhase.ChangePlanning, RunPhase.AwaitingPlanApproval, RunPhase.MutationPreparation }],
        [new[] { RunPhase.EvidenceCollection, RunPhase.ChangePlanning, RunPhase.AwaitingPlanApproval, RunPhase.MutationPreparation, RunPhase.AwaitingMutationApproval }],
        [new[] { RunPhase.EvidenceCollection, RunPhase.ChangePlanning, RunPhase.AwaitingPlanApproval, RunPhase.MutationPreparation, RunPhase.AwaitingMutationApproval, RunPhase.Mutation }],
        [new[] { RunPhase.EvidenceCollection, RunPhase.ChangePlanning, RunPhase.AwaitingPlanApproval, RunPhase.MutationPreparation, RunPhase.AwaitingMutationApproval, RunPhase.Mutation, RunPhase.Compilation }],
        [new[] { RunPhase.EvidenceCollection, RunPhase.ChangePlanning, RunPhase.AwaitingPlanApproval, RunPhase.MutationPreparation, RunPhase.AwaitingMutationApproval, RunPhase.Mutation, RunPhase.RolledBack }],
        [new[] { RunPhase.EvidenceCollection, RunPhase.ChangePlanning, RunPhase.AwaitingPlanApproval, RunPhase.MutationPreparation, RunPhase.AwaitingMutationApproval, RunPhase.Mutation, RunPhase.Compilation, RunPhase.Testing }],
        [new[] { RunPhase.EvidenceCollection, RunPhase.ChangePlanning, RunPhase.AwaitingPlanApproval, RunPhase.MutationPreparation, RunPhase.AwaitingMutationApproval, RunPhase.Mutation, RunPhase.Compilation, RunPhase.RolledBack }],
        [new[] { RunPhase.EvidenceCollection, RunPhase.ChangePlanning, RunPhase.AwaitingPlanApproval, RunPhase.MutationPreparation, RunPhase.AwaitingMutationApproval, RunPhase.Mutation, RunPhase.Compilation, RunPhase.Testing, RunPhase.Verification }],
        [new[] { RunPhase.EvidenceCollection, RunPhase.ChangePlanning, RunPhase.AwaitingPlanApproval, RunPhase.MutationPreparation, RunPhase.AwaitingMutationApproval, RunPhase.Mutation, RunPhase.Compilation, RunPhase.Testing, RunPhase.RolledBack }],
        [new[] { RunPhase.EvidenceCollection, RunPhase.ChangePlanning, RunPhase.AwaitingPlanApproval, RunPhase.MutationPreparation, RunPhase.AwaitingMutationApproval, RunPhase.Mutation, RunPhase.Compilation, RunPhase.Testing, RunPhase.Verification, RunPhase.AwaitingAcceptance }],
        [new[] { RunPhase.EvidenceCollection, RunPhase.ChangePlanning, RunPhase.AwaitingPlanApproval, RunPhase.MutationPreparation, RunPhase.AwaitingMutationApproval, RunPhase.Mutation, RunPhase.Compilation, RunPhase.Testing, RunPhase.Verification, RunPhase.AwaitingAcceptance, RunPhase.Completion }],
        [new[] { RunPhase.EvidenceCollection, RunPhase.ChangePlanning, RunPhase.AwaitingPlanApproval, RunPhase.MutationPreparation, RunPhase.AwaitingMutationApproval, RunPhase.Mutation, RunPhase.Compilation, RunPhase.Testing, RunPhase.Verification, RunPhase.AwaitingAcceptance, RunPhase.RolledBack }],
        [new[] { RunPhase.Failed }],
        [new[] { RunPhase.Cancelled }],
    ];
    ...
    public static async Task StateMachine_AllPhasePairs_MatchTheTransitionMatrix()
    {
        ...
        var allowed = LegalTransitionPaths
            .Select(item => (RunPhase[])item[0])
    ...
    public static async Task SessionApplication_ProjectsTerminalState_AndDetachedSnapshots()
    {
        ...
        Assert.Contains("hello", string.Join(string.Empty, first.Activity));
    ...
    public static async Task TuiController_DrivesInteractiveCommandBoundary()
    {
        ...
        Assert.Equal(RunPhase.Completion.ToString(), snapshot.Status);
    }
    ...
    public static async Task TuiController_CancelActiveRun_ProducesCancelledState()
    {
        ...
        Assert.Null(controller.ActiveRunId);
        Assert.Equal(RunPhase.Cancelled.ToString(), snapshot.Status);
    }
