namespace Threadsmith.Tests.Fixtures.ConflictingDepB;

using Threadsmith.Extensions.Abstractions;
using Threadsmith.PrivateLib;

/// <summary>Fixture bundling PrivateLib v2.0; surfaces the resolved private version in its tool description.</summary>
public sealed class ConflictingDepBExtension : IThreadsmithExtension
{
    /// <inheritdoc />
    public ExtensionDescriptor Descriptor { get; } = new()
    {
        Id = "threadsmith.tests.conflicting-dep-b",
        Name = "ConflictingDepB Fixture",
        Version = "2.0.0",
...
internal sealed class ProbeToolCapability : IToolCapability
{
    ...
    {
        Id = "conflicting_dep_b_probe",
        Kind = CapabilityKind.Tool,
        DisplayName = "ConflictingDepB Probe",
    };
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        return Task.FromResult(new ExtensionToolResult
        {
            ...
            Sources = [new ExtensionProvenanceSource("extension", "conflicting_dep_b_probe")],
        });
    }
